...
export default function CartClient({ suggestions }: Props) {
    ...
    return (
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-2xl mb-3" style={{ fontFamily: 'Playfair Display, serif' }}>Your cart is empty</h1>
          <p className="text-gray-500 mb-7">Your wardrobe is waiting — explore the collection.</p>
        ...
        {suggestions.length > 0 && (
          <div className="border-t pt-8" style={{ borderColor: '#E8DDD4' }}>
            <div className="flex justify-between items-center mb-5">
              <h2 className="text-sm font-bold uppercase tracking-widest" style={{ color: '#A68B6E' }}>You Might Like</h2>
              <Link href="/shop" className="text-xs font-semibold uppercase tracking-widest hover:opacity-70" style={{ color: '#A68B6E' }}>
                View All →
              </Link>
            </div>
