...
async function ProductGrid({ searchParams }: { searchParams: { size?: string; min?: string; max?: string } }) {
...
export default async function ShopPage({ searchParams }: { searchParams: Promise<{ size?: string; min?: string; max?: string }> }) {
