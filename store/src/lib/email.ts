...
export type EmailItem = { product_id?: string; product_name: string; sku?: string; size: string; color: string; quantity: number; price: number }
...
export async function sendCustomerPaymentConfirmed(to: string | null | undefined, d: {
  ...
  try {
    const invoicePdf = d.invoice_number
